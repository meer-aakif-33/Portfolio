...
export default function About() {
  return (
    <section className="min-h-screen px-6 py-24 bg-gray-100 dark:bg-gradient-to-br dark:from-zinc-900 dark:to-zinc-800 flex items-center justify-center">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 dark:from-cyan-400 dark:to-indigo-400 mb-6">
          About Me
        </h2>
        <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed tracking-wide">
          ...
          efficiency, and a drive to continuously learn and build things that matter.
        </p>
      </motion.div>
    </section>
  );
